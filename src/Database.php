...
final class DatabaseMigrator
{
    ...
    private function migrations(string $driver): array
    {
        ...
        return [
            ...
            [
                'version' => 'php-' . $suffix . '-22-private-location-history',
                'file' => dirname(__DIR__) . '/database/migrations/022-private-location-history.' . $suffix . '.sql',
                'base' => false,
                'ignoreDuplicateIndex' => false,
                'resumable' => true,
            ],
            [
                'version' => 'php-' . $suffix . '-23-native-push-devices',
                'file' => dirname(__DIR__) . '/database/migrations/023-native-push-devices.' . $suffix . '.sql',
                'base' => false,
                'ignoreDuplicateIndex' => false,
                'resumable' => true,
            ],
